structure_filter <- function(known_structure, desire_layers, dynamic_variables, static_variables,
  ...
  blacklist <- filter_blacklist(desire_layers, dynamic_variables, static_variables, is_blacklist_internal, is_blacklist_other,
...
filter_whitelist <- function(known_structure, desire_layers, dynamic_variables, static_variables,
                             is_blacklist_internal, is_variable_only, rho, corr_threshold,
                             custom_blacklist, custom_whitelist) {
  graph_full <- NULL
...
filter_blacklist <- function(desire_layers, dynamic_variables, static_variables, is_blacklist_internal, is_blacklist_other,
                             custom_blacklist, whitelist = NULL) {


  if(is_blacklist_other && !is.null(whitelist)) {
    return(blacklist_all(c(static_variables, dynamic_variables), whitelist, desire_layers))
  } else {
    ...
    blacklist_static <- get_static_blacklist(static_variables, dynamic_variables)
    blacklist <- rbind(blacklist, blacklist_static)

    blacklist <- filter_unknow_arc(blacklist, c(static_variables, dynamic_variables))
